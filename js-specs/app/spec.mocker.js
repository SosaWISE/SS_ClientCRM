define(['mocker'], function(mocker) {
  ...
  describe('mocker', function() {
    ...
    describe('strings w/ tokens', function() {
      var resp;
      beforeEach(function() {
        spyOn(mocker.fn, 'NUMBER').andReturn(10);
        resp = mocker.fromTemplate({
          num: '@NUMBER(1,2)',
        });
      });
      ...
      it('should call corresponding fn function', function() {
        expect(mocker.fn.NUMBER).toHaveBeenCalled();
      ...
      it('should call function with params', function() {
        ...
        expect(mocker.fn.NUMBER).toHaveBeenCalledWith(expectedCache, '1', '2');
      });
    });
    ...
    describe('property names w/ range values (eg: name|1-10)', function() {
      var resp,
        expectedName = 'bob+';
      beforeEach(function() {
        spyOn(mocker.fn, 'NAME').andReturn('bob');
        resp = mocker.fromTemplate({
          'txt|5-10': '@NAME+',
          'ray|5-10': ['@NAME+'],
        });
