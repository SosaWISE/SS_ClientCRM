define('src/survey/questionmeaning.vm', [
  'src/survey/qmtokenmap.vm',
  'src/dataservice',
  'ko',
  'src/core/notify',
  'src/core/utils',
  ...
  function QuestionMeaningViewModel(options) {
    ...
    ControllerViewModel.ensureProps(_this, ['tokensVM']);
  ...
  QuestionMeaningViewModel.prototype.onLoad = function(routeData, extraData, join) { // overrides base
    var _this = this,
      cb = join.add();
