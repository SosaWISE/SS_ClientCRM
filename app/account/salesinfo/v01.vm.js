define("src/account/salesinfo/v01.vm", [
  "underscore",
  ...
  function SalesInfoV01ViewModel(options) {
    var _this = this;
    SalesInfoV01ViewModel.super_.call(_this, options);
  ...
  utils.inherits(SalesInfoV01ViewModel, BaseViewModel);
  SalesInfoV01ViewModel.prototype.viewTmpl = "tmpl-salesinfo-v01";

  SalesInfoV01ViewModel.prototype.onLoad = function(routeData, extraData, join) { // overrides base
    var _this = this,
  ...
  SalesInfoV01ViewModel.prototype.num = function(first) {
    var _this = this;
    if (first) {
      _this._num = first;
    }
  ...
  SalesInfoV01ViewModel.prototype.subnum = function() {
    var _this = this;
    return strings.format("{0}.{1}.", _this._num - 1, _this._subnum++);
  };

  SalesInfoV01ViewModel.prototype.refreshInvoice = function(cb) {
    var _this = this,
      data;
    if (!utils.isFunc(cb)) {
      cb = utils.noop;
