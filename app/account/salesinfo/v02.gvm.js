define("src/account/salesinfo/v02.gvm", [
  "ko",
  ...
  function SalesInfoV02GridViewModel(options) {
    var _this = this;
    SlickGridViewModel.ensureProps(options, ["deletePart"]);
    SalesInfoV02GridViewModel.super_.call(_this, {
      gridOptions: {
  ...
  utils.inherits(SalesInfoV02GridViewModel, SlickGridViewModel);

  return SalesInfoV02GridViewModel;
});
