define("src/salesreports/rankings.report.vm", [
  "src/ukov",
  "dataservice",
  "src/core/combo.vm",
  "ko",
  ...
  function RankingsReportViewModel(options) {
    var _this = this;
    RankingsReportViewModel.super_.call(_this, options);
    ...
    _this.filterRange.subscribe(function(newValue) {
      ...
      loadRankingsReport(_this, function() {});
    });
    ...
    _this.cmdGo = ko.command(function(cb) {
      loadRankingsReport(_this, cb);
    });
  }
  utils.inherits(RankingsReportViewModel, ControllerViewModel);

  RankingsReportViewModel.prototype.viewTmpl = "tmpl-salesreports-rankings-report";

  RankingsReportViewModel.prototype.onLoad = function(routeData, extraData, join) { // overrides base
    var _this = this;
  ...
  function loadRankingsReport(_this, cb) {
    ...
    _this.dataLoaded(false);
    load_report("SalesRepRankings", query, function(resp) {
      console.log("SalesRepRankings Resp: ", resp);
      _this.accounts(resp);
  ...
  return RankingsReportViewModel;
});